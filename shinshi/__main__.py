...
from shinshi.localization_provider import LocalizationProvider
...
bot: GatewayBot = GatewayBot(token, intents=Intents.GUILDS)
client: Client = Client(
    bot,
    l10n=LocalizationProvider(base_path=Path("resources", "l10n")),
